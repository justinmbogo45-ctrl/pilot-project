...
export const FirmMatchQuiz: React.FC<FirmMatchQuizProps> = ({
 ...
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[#3ecf8e] text-xs font-bold uppercase tracking-wider">
 ...
 {/* QUESTION SCREENS */}
 {!quizFinished ? (
 <div className="bg-[#1a1c1b] border border-[#2b2e2c] rounded-2xl p-6 sm:p-8 space-y-6">
 
 {/* STEP 1: MARKETS & RESIDENCY */}
 {step === 1 && (
 <div className="space-y-6">
 <div>
 <span className="text-xs font-bold text-[#3ecf8e] uppercase tracking-wider">Step 1 of 4</span>
 <h3 className="text-lg font-bold text-white mt-1">What markets do you trade?</h3>
 <p className="text-xs text-[#747976]">Select your primary asset class.</p>
 </div>
 ...
 market === item.id
 ? 'bg-emerald-500/15 border-emerald-500/60 text-[#3ecf8e] ring-1 ring-emerald-500/40'
 : 'bg-[#1d1f1e] border-[#2b2e2c] text-[#9a9e9b] hover:border-[#333633]'
 }`}
 >
 <div className="font-bold text-sm text-white">{item.label}</div>
 <div className="text-[11px] text-[#747976] mt-1">{item.desc}</div>
 </button>
 ))}
 </div>
 ...
 {/* US Resident Toggle */}
 <div className="pt-2">
 <label className="flex items-center gap-3 p-3.5 rounded-xl bg-[#1d1f1e] border border-[#2b2e2c] cursor-pointer text-xs">
 <input
 type="checkbox"
 checked={isUSResident}
 onChange={(e) => setIsUSResident(e.target.checked)}
 className="w-4 h-4 rounded text-emerald-500 bg-[#222522] border-[#333633]"
 />
 <div>
 <span className="font-bold text-white block">I am a United States resident</span>
 <span className="text-[#747976]">
 ...
 <div className="space-y-6">
 <div>
 <span className="text-xs font-bold text-[#3ecf8e] uppercase tracking-wider">Step 2 of 4</span>
 <h3 className="text-lg font-bold text-white mt-1">Trading Strategy & Rule Tolerances</h3>
 <p className="text-xs text-[#747976]">Choose which rules you need freedom in.</p>
 </div>

 <div className="space-y-3">
 <label className="flex items-center justify-between p-4 rounded-xl bg-[#1d1f1e] border border-[#2b2e2c] cursor-pointer">
 <div>
 <span className="font-bold text-white text-xs block">Weekend Holding</span>
 <span className="text-[11px] text-[#747976]">
 ...
 <div className="space-y-6">
 <div>
 <span className="text-xs font-bold text-[#3ecf8e] uppercase tracking-wider">Step 3 of 4</span>
 <h3 className="text-lg font-bold text-white mt-1">Evaluation & Funding Model</h3>
 <p className="text-xs text-[#747976]">How quickly do you want to start receiving payouts?</p>
 </div>
 ...
 <div className="text-[11px] text-[#747976] mt-2 leading-relaxed">{item.desc}</div>
 </button>
 ))}
 </div>
 </div>
 ...
 <div className="space-y-6">
 <div>
 <span className="text-xs font-bold text-[#3ecf8e] uppercase tracking-wider">Step 4 of 4</span>
 <h3 className="text-lg font-bold text-white mt-1">Account Size & Primary Goal</h3>
 <p className="text-xs text-[#747976]">Select your capital target and primary decision factor.</p>
 </div>

 {/* Capital size buttons */}
 <div className="space-y-2">
 <span className="text-xs font-semibold text-[#9a9e9b]">Target Capital Size:</span>
 ...
 preferredSize === size
 ? 'bg-[#3ecf8e] text-[#171918] border-emerald-400 shadow-sm'
 : 'bg-[#1d1f1e] text-[#9a9e9b] border-[#2b2e2c] hover:bg-[#222522]'
 }`}
 >
 ${size / 1000}K
 </button>
 ...
 <span className="text-xs font-semibold text-[#9a9e9b]">What matters most to you?</span>
 ...
 priority === p.id
 ? 'bg-emerald-500/15 border-emerald-500/50 text-[#3ecf8e]'
 : 'bg-[#1d1f1e] border-[#2b2e2c] text-[#747976] hover:text-[#9a9e9b]'
 }`}
 >
 {p.label}
 </button>
 ...
 {/* Navigation Buttons */}
 <div className="flex items-center justify-between pt-4 border-t border-[#2b2e2c]">
 {step > 1 ? (
 <button
 onClick={() => setStep(step - 1)}
 className="flex items-center gap-1 text-xs font-semibold text-[#747976] hover:text-white px-3 py-2 rounded-lg transition-colors duration-150"
 >
 ...
 <button
 onClick={() => setStep(step + 1)}
 className="flex items-center gap-1.5 text-xs font-bold bg-[#3ecf8e] hover:bg-[#4eda9a] text-[#171918] px-5 py-2.5 rounded-lg shadow-emerald-500/20 transition-all"
 >
 <span>Continue</span>
 ...
 className="flex items-center gap-1.5 text-xs font-bold bg-[#3ecf8e] hover:bg-[#4eda9a] text-[#171918] px-6 py-2.5 rounded-lg shadow-emerald-500/30 transition-all"
 >
 <Sparkles className="w-4 h-4 text-[#171918]" />
 ...
 <button
 onClick={restartQuiz}
 className="flex items-center gap-1 text-xs font-semibold text-[#747976] hover:text-[#3ecf8e] transition-colors duration-150"
 >
 ...
 <div
 key={item.firm.id}
 className="bg-[#1a1c1b] border border-[#2b2e2c] rounded-2xl p-6 relative overflow-hidden hover:border-[#333633] transition-all"
 >
 {/* Match Score Badge */}
 <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-[#2b2e2c]/80">
 <div className="flex items-center gap-3">
 <span className={`w-7 h-7 rounded-full flex items-center justify-center font-black text-xs ${
 rank === 0 ? 'bg-amber-400 text-[#171918]' : 'bg-[#222522] text-[#9a9e9b]'
 }`}>
 #{rank + 1}
 </span>
 <img
 src={item.firm.logo}
 alt={item.firm.name}
 className="w-10 h-10 rounded-xl object-cover border border-[#333633]"
 />
 <div>
 ...
 <div className="text-xs text-[#747976] flex items-center gap-1">
 ...
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-[#3ecf8e] font-bold text-sm">
 ...
 <span className="text-[11px] uppercase tracking-wider font-bold text-[#747976]">
 Why this fits your trading profile:
 </span>
 <div className="flex flex-wrap gap-2">
 {item.reasons.map((r, i) => (
 <span key={i} className="inline-flex items-center gap-1.5 text-xs bg-[#1d1f1e] border border-[#2b2e2c] text-[#9a9e9b] px-2.5 py-1 rounded-lg">
 ...
 className="text-xs font-semibold text-[#9a9e9b] hover:text-white underline"
 >
 ...
 className="px-4 py-2 rounded-lg bg-[#3ecf8e] hover:bg-[#4eda9a] text-[#171918] font-bold text-xs flex items-center gap-1.5 shadow-emerald-500/20 transition-all"
 >
